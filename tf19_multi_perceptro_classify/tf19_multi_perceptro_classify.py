...
http://c.biancheng.net/view/1921.html
"""
...
def multilayer_perceptron(x):
    ...
    out = layers.fully_connected(fc1, n_classed, activation_fn=None, scope="out")
    return out


x = tf.placeholder(tf.float32, [None, n_input], name="placeholder_x")
y = tf.placeholder(tf.float32, [None, n_classed], name="placeholder_y")
...
with tf.Session() as sess:
    ...
    for epoch in range(10):
        ...
        print("Epoch %2d, Loss %.6f" % (epoch, epoch_loss))
